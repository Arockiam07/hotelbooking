          ...
          <div class="row h-100 align-items-end justify-content-center">
            <div class="col-12 col-md-11 col-xl-10">
              <div class="footer-logo-wrapper">
                <a href="#!">
                  <img src={logo} alt="BootstrapBrain Logo" width="200" height="160"/>
                </a>
              </div>
              ...
              <div class="address-wrapper mt-5">
                ...
                <p class="mb-2">
                  <a class="link-light text-decoration-none" href="tel:+15057922430">+91 985676890</a>
                </p>
                <p class="mb-0">
            ...
            <div class="col-12 col-md-11 col-xxl-10">
              ...
              <div class="row mt-6 border-top border-light-subtle">
                ...
                <div class="credits text-secondary mt-2 fs-7">
                  Built by <a href="#" class="link-secondary text-decoration-none">kevi</a> <span class="text-primary">&#9829;</span>
                </div>
              </div>
            </div>
          </div>
